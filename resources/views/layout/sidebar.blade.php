...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('laporan.pasien-meninggal') }}">
          <i class="ri-bar-chart-grouped-fill"></i>
          <span>Data pasien Meninggal</span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('laporan.rujukan-keluar') }}">
          <i class="ri-bar-chart-grouped-fill"></i>
      ...
      <li class="nav-item">
          <a class="nav-link collapsed" href="{{ route('morbiditas-rawat-jalan') }}">
              <i class="ri-bar-chart-grouped-fill"></i>
