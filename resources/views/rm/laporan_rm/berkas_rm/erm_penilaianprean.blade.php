...
<head>
  ...
  <title>ERM - Penilaian Pra Anestesi</title>
...
<body>
  <h5 style="color:BLUE;">ERM - Penilaian Pra Anestesi</h5>
              ...
              <tr>
                ...
                <td>
                  <?php if (!$penilaianprean->isEmpty()) { ?>
                    ...
                    <?php } ?>
                  <?php } else { ?>
                    Tidak ada data Penilaian Pra Anestesi.
                  <?php } ?>
                </td>
              </tr>
            </table>
