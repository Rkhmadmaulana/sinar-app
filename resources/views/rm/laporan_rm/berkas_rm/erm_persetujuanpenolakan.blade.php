                  ...
                  <?php if (!$persetujuanpenolakan->isEmpty()) { ?>
                    <?php foreach($persetujuanpenolakan as $i) { ?>
                      <table border="1px" style="width:100%;">
                          ...
                          <tr><th>Alasan Diwakilkan Penerima Informasi</th><td><?php echo $i->alasan_diwakilkan_penerima_informasi ?? '-'; ?></td></tr>
                          <tr><th>Jk Penerima Informasi</th><td><?php echo $i->jk_penerima_informasi ?? '-'; ?></td></tr>
                          <tr><th>Tanggal Lahir Penerima Informasi</th><td><?php echo $i->tanggal_lahir_penerima_informasi ?? '-'; ?></td></tr>
                          <tr><th>Umur Penerima Informasi</th><td><?php echo $i->umur_penerima_informasi ?? '-'; ?></td></tr>
                          <tr><th>Alamat Penerima Informasi</th><td><?php echo $i->alamat_penerima_informasi ?? '-'; ?></td></tr>
                          <tr><th>No Hp</th><td><?php echo $i->no_hp ?? '-'; ?></td></tr>
                          <tr><th>Hubungan Penerima Informasi</th><td><?php echo $i->hubungan_penerima_informasi ?? '-'; ?></td></tr>
