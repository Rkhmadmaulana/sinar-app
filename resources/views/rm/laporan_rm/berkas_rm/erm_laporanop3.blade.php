...
<body>
  <h5 style="color:BLUE;">ERM Ranap - Laporan Operasi 3</h5>
        ...
        <tr>
          <td>
            <table class="table table-bordered" style="width:100%;">
              ...
              <tr>
                <td>Laporan Operasi 3</td>
                <td>:</td>
                <td>
                  @if ($laporanop3)
                    <table class="table table-bordered sub-table" style="width:100%;">
                      <tr><th>Nama Dokter</th><td>{{ $laporanop3->nm_dokter }}</td></tr>
                      <tr><th>Waktu Mulai Operasi</th><td>{{ $laporanop3->tanggal }}</td></tr>
                      <tr><th>Waktu Selesai Operasi</th><td>{{ $laporanop3->selesaioperasi }}</td></tr>
                      <tr><th>Diagnosa Preop</th><td>{{ $laporanop3->diagnosa_preop }}</td></tr>
                      <tr><th>Diagnosa Postop</th><td>{{ $laporanop3->diagnosa_postop }}</td></tr>
                      <tr><th>Jaringan Dieksisi</th><td>{{ $laporanop3->jaringan_dieksekusi }}</td></tr>
                      <tr><th>Permintaan PA</th><td>{{ $laporanop3->permintaan_pa }}</td></tr>
                      <tr><th>Nama / Macam Operasi</th><td>{{ $laporanop3->jenis_operasi }}</td></tr>
                      <tr>
                        <th>Laporan</th>
                        <td>
                            <ul style="padding-left: 16px;">
                            @foreach(explode('-', $laporanop3->laporan_operasi_3) as $item)
                                @if(trim($item) != '')
                                <li>{{ trim($item) }}</li>
                                @endif
                            @endforeach
                      ...
                      <tr><th>Instruksi Post Operasi</th><td>{{ $laporanop3->instruksi }}</td></tr>
                    </table>
                  @else
