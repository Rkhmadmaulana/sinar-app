                  ...
                  <?php if (!$resiko_anak->isEmpty()) { ?>
                    <?php foreach($resiko_anak as $item) { ?>
                      <table border="1px" style="width:100%;">
                        ...
                        <tr><td>Umur</td><td><?php echo $item->penilaian_humptydumpty_skala1; ?></td></tr>
                        <tr><td>Jenis Kelamin</td><td><?php echo $item->penilaian_humptydumpty_skala2; ?></td></tr>
                        <tr><td>Diagnosa</td><td><?php echo $item->penilaian_humptydumpty_skala3; ?></td></tr>
                        <tr><td>Gangguan Kognitif</td><td><?php echo $item->penilaian_humptydumpty_skala4; ?></td></tr>
                        <tr><td>Faktor Lingkungan</td><td><?php echo $item->penilaian_humptydumpty_skala5; ?></td></tr>
                        <tr><td>Waktu Respon</td><td><?php echo $item->penilaian_humptydumpty_skala6; ?></td></tr>
                        <tr><td>Riwayat Jatuh</td><td><?php echo $item->penilaian_humptydumpty_skala7; ?></td></tr>
                        <tr><td><b>Total skala</b></td><td><b><?php echo $item->penilaian_humptydumpty_totalnilai; ?></b></td></tr>
