...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Morbiditas Pasien Rawat Inap</h3>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('morbiditas-rawat-inap') }}">
                @csrf
            ...
            <div class="mb-3">
                <a href="{{ route('morbiditas-rawat-inap.excel') }}?tanggal_awal={{ $tanggalAwal }}&tanggal_akhir={{ $tanggalAkhir }}" 
                ...
                <table class="table morbiditas-table">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th colspan="50" class="columm-header-parent">Jumlah Pasien Keluar Hidup dan Mati Menurut Kelompok Umur & Jenis Kelamin</th>
                            <th colspan="3" rowspan="2" class="columm-header-parent" width="200px">Jumlah Pasien Keluar<br> Hidup dan Mati <br> Menurut Jenis Kelamin</th>
                            <th colspan="3" rowspan="2" class="columm-header-parent" width="200px">Jumlah Pasien Keluar Mati</th>
                        </tr>
                    ...
                    <tbody>
                        @foreach($data as $item)
                            <tr>
                                ...
                                <td class="total-col" style="background-color:gainsboro;">{{ $item->total_pasien_keluar }}</td>
                                <td class="total-col" style="background-color: papayawhip;">{{ $item->pasien_keluar_mati_L }}</td>
                                <td class="total-col" style="background-color: papayawhip;">{{ $item->pasien_keluar_mati_P }}</td>
                                <td class="total-col" style="background-color:gainsboro;">{{ $item->total_pasien_keluar_mati }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
