...
<div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card-header d-flex align-items-center justify-content-between pb-0">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <form id="filterForm" action="{{ route('kematian') }}" method="POST">
                                @csrf
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12 order-0 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <center>LAPORAN BULANAN<br>REKAPITULASI KEMATIAN<br>{{ $tgllap }}
                    </center>
                    ...
                    <div class="table-responsive">
                        <table style="width:100%;" class="table-bordered">
                            ...
                            <tr>
                                <td style="text-align: center;">{{ $anggota->total }}</td>
                                <td style="text-align: center;">{{ $pns->total }}</td>
                                <td style="text-align: center;">{{ $keluarga->total }}</td>
                                <td style="text-align: center;">{{ $dikbang->total }}</td>
                                <td style="text-align: center;">{{ $diktuk->total }}</td>
                                <td style="text-align: center;">{{ $umum->total }}</td>
                                <td style="text-align: center;">{{ $bpjs }}</td>
                                <td style="text-align: center;">{{ $lainnya->total }}</td>
                                <td style="text-align: center;background-color: #F47174;">{{ $total }}</td>
                            </tr>
                        </table>
<br/>
                        <table style="width:100%;" class="table-bordered">
                            <tr>
                                <th style="text-align: center;background-color: #bdd9bf;">Rawat Inap</th>
                                <th style="text-align: center;background-color: #bdd9bf;">IGD</th>
                                <th style="text-align: center;background-color: #bdd9bf;">Total</th>
                            </tr>
                            <tr>
                                <td style="text-align: center;">{{ $ranap->total2 }}</td>
                                <td style="text-align: center;">{{ $igd->total2 }}</td>
                                <td style="text-align: center;background-color: #F47174;">{{ $total2 }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
