...
<div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card-header d-flex align-items-center justify-content-between pb-0">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <form id="filterForm" action="{{ route('penyakitterbanyak') }}" method="POST">
                                @csrf
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12 order-0 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <center>LAPORAN BULANAN<br>10 JENIS PENYAKIT PASIEN TERBANYAK RAWAT INAP <br>{{ $tgllap }}
                    </center>
                    <small style="color:red;">*Data dibawah ini berdasarkan Tanggal Registrasi Pasien Ranap</small><br><br>
                    <div class="table-responsive">
                        <table style="width:100%;" class="table-bordered">
                            <tr>
                                <th style="text-align: center;background-color: #bdd9bf;">Penyakit</th>
                            ...
                            <tr>
                                <td style="text-align: center;background-color: #bdd9bf;">{{ $a->nama }} - ({{ $a->kode }})</td>
                                <td style="text-align: center;">  
                                    <?php
                                    // Query SQL dipisahkan dari Blade
                                    $query_result = DB::select("SELECT COUNT(*) as total FROM diagnosa_pasien 
                                ...
                                <td style="text-align: center;">  
                                    <?php
                                    // Query SQL dipisahkan dari Blade
                                    $query_result2 = DB::select("SELECT COUNT(*) as total FROM diagnosa_pasien 
                                                                JOIN reg_periksa ON diagnosa_pasien.no_rawat = reg_periksa.no_rawat 
                                                                JOIN pasien_polri ON pasien_polri.no_rkm_medis = reg_periksa.no_rkm_medis
                                                                WHERE diagnosa_pasien.kd_penyakit = ? 
                                                                AND reg_periksa.status_lanjut = 'Ranap' 
                                ...
                                <td style="text-align: center;">  
                                    <?php
                                    // Query SQL dipisahkan dari Blade
                                    $query_result3 = DB::select("SELECT COUNT(*) as total FROM diagnosa_pasien 
                                                                JOIN reg_periksa ON diagnosa_pasien.no_rawat = reg_periksa.no_rawat 
                                                                JOIN pasien_polri ON pasien_polri.no_rkm_medis = reg_periksa.no_rkm_medis
                                                                WHERE diagnosa_pasien.kd_penyakit = ? 
                                                                AND reg_periksa.status_lanjut = 'Ranap' 
                                ...
                                <td style="text-align: center;">  
                                    <?php
                                    // Query SQL dipisahkan dari Blade
                                    $query_result4 = DB::select("SELECT COUNT(*) as total FROM diagnosa_pasien 
                                                                JOIN reg_periksa ON diagnosa_pasien.no_rawat = reg_periksa.no_rawat 
                                                                JOIN pasien_polri ON pasien_polri.no_rkm_medis = reg_periksa.no_rkm_medis
                                                                WHERE diagnosa_pasien.kd_penyakit = ? 
                                                                AND reg_periksa.status_lanjut = 'Ranap' 
                                ...
                                <td style="text-align: center;">  
                                    <?php
                                    // Query SQL dipisahkan dari Blade
                                    $query_result5 = DB::select("SELECT COUNT(*) as total FROM diagnosa_pasien 
                                                                JOIN reg_periksa ON diagnosa_pasien.no_rawat = reg_periksa.no_rawat 
                                                                JOIN pasien_polri ON pasien_polri.no_rkm_medis = reg_periksa.no_rkm_medis
                                                                WHERE diagnosa_pasien.kd_penyakit = ? 
                                                                AND reg_periksa.status_lanjut = 'Ranap' 
                                ...
                                <td style="text-align: center;">  
                                    <?php
                                    // Query SQL dipisahkan dari Blade
                                    $query_umum = DB::select("SELECT COUNT(*) as total FROM diagnosa_pasien 
                                                                JOIN reg_periksa ON diagnosa_pasien.no_rawat = reg_periksa.no_rawat
                                                                WHERE diagnosa_pasien.kd_penyakit = ? 
                                                                AND reg_periksa.status_lanjut = 'Ranap' 
                                                                AND reg_periksa.tgl_registrasi BETWEEN ? AND ?
                                ...
                                <td style="text-align: center;">  
                                    <?php
                                    // Query SQL dipisahkan dari Blade
                                    $query_bpj = DB::select("SELECT COUNT(*) as total FROM diagnosa_pasien 
                                                                JOIN reg_periksa ON diagnosa_pasien.no_rawat = reg_periksa.no_rawat
                                                                WHERE diagnosa_pasien.kd_penyakit = ? 
                                                                AND reg_periksa.status_lanjut = 'Ranap' 
                                                                AND reg_periksa.tgl_registrasi BETWEEN ? AND ?
                                ...
                                <td style="text-align: center;">  
                                    <?php
                                    // Query SQL dipisahkan dari Blade
                                    $query_other = DB::select("SELECT COUNT(*) as total FROM diagnosa_pasien 
                                                                JOIN reg_periksa ON diagnosa_pasien.no_rawat = reg_periksa.no_rawat
                                                                WHERE diagnosa_pasien.kd_penyakit = ? 
                                                                AND reg_periksa.status_lanjut = 'Ranap' 
                                                                AND reg_periksa.tgl_registrasi BETWEEN ? AND ?
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12 order-0 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <center>LAPORAN BULANAN<br>10 JENIS PENYAKIT PASIEN TERBANYAK RAWAT JALAN <br>{{ $tgllap }}
                    </center>
                    <small style="color:red;">*Data dibawah ini berdasarkan Tanggal Registrasi Pasien Ralan</small><br><br>
                    <div class="table-responsive">
                        <table style="width:100%;" class="table-bordered">
                            <tr>
                                <th style="text-align: center;background-color: #bdd9bf;">Penyakit</th>
    ...
    <div class="row">
        <div class="col-md-6 col-lg-6 col-xl-6 order-0 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <center>LAPORAN<br>JUMLAH PASIEN BARU RSUD PANGERAN JAYA SUMITRA <br>{{ $tgllap }}
                    </center>
                    <small style="color:red;">*Data dibawah ini berdasarkan Tanggal Registrasi</small><br><br>
                    <div class="table-responsive">
                        Jumlah Pasien Baru : {{ $pasien_baru->pasienbaru ?? 0 }}
                    </div>
                </div>
            </div>
        </div>
