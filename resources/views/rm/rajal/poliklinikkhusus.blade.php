...
@section('title', 'Dashboard Rawat Jalan - Poliklinik Khusus')
@section('content')
@if(!($isAjax ?? false))
    ...
    <div class="card border-0 shadow-sm" style="border-radius:12px;">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center flex-wrap gap-2" style="border-radius:12px 12px 0 0;border-bottom:2px solid #e9ecef;">
            <h5 class="mb-0 fw-semibold text-dark">
                <i class="fas fa-stethoscope me-2"></i> Dashboard Rawat Jalan - Poliklinik Khusus (Medical Check Up)
            </h5>
        </div>
        <div class="card-body px-4 py-3">

            {{-- Filter Form --}}
            <form id="filterForm" action="{{ route('allpoliklinikkhusus', ['kd_poli' => request()->route('kd_poli')]) }}" method="POST">
                @csrf
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm" style="background:linear-gradient(135deg,#667eea,#764ba2);color:#fff;border-radius:12px;padding:20px;">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <i class="fas fa-stethoscope" style="font-size:2.5rem;opacity:.25;"></i>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
