...
@section('title', 'Dashboard Rawat Jalan - Penunjang')
@section('content')
@if(!($isAjax ?? false))
    ...
    <div class="card border-0 shadow-sm" style="border-radius:12px;">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center flex-wrap gap-2" style="border-radius:12px 12px 0 0;border-bottom:2px solid #e9ecef;">
            <h5 class="mb-0 fw-semibold text-dark">
                <i class="fas fa-hospital me-2"></i> Dashboard Rawat Jalan - Penunjang
            </h5>
        </div>
        <div class="card-body px-4 py-3">

            {{-- Filter Form --}}
            <form id="filterForm" action="{{ route('penunjang', ['kd_poli' => request()->route('kd_poli')]) }}" method="POST">
                @csrf
                    ...
                    <div class="card border-0 shadow-sm" style="background:linear-gradient(135deg,#667eea,#764ba2);color:#fff;border-radius:12px;padding:20px;">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small style="opacity:.7;">Penunjang</small>
                            </div>
                            <i class="fas fa-microscope" style="font-size:2.5rem;opacity:.25;"></i>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
