...
class RajalController extends Controller
{
    ...
    {   
            ...
            // Start Line Chart
            $grafik_umum = $this->getChartData('UMU', $tgl1, $tgl2, $kdpoli, $kddokter, $status);
    ...
    // end Pilihan Cara Bayar
        ...
        // Start Line Chart
            $grafik_umum = $this->getChartData2('UMU', $tgl1, $tgl2, $kdpoli, $kddokter, $status);
    ...
    public function penunjang(Chart $chart,Request $request, $kd_poli)
    {   
            $tgl1 = $request->input('tgl1');
            $tgl2 = $request->input('tgl2');
            $kdpoli = $kd_poli;
        ...
        // Start Line Chart
            $grafik_umum = $this->getChartData3('UMU', $tgl1, $tgl2, $kdpoli, $kddokter, $status);
            $grafik_bpjs = $this->getChartData3('BPJ', $tgl1, $tgl2, $kdpoli, $kddokter, $status);
        ...
        //start return
                return view('rm.rajal.penunjang', [
                    // untuk mengirim data dalam form
                    'tgl1' => $tgl1,
                    'tgl2' => $tgl2,
                    'kddokter' => $kddokter,
