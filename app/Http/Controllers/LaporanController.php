...
class LaporanController extends Controller{
    ...
    {
        $pdf = PDF::loadView('rm.laporan_rm.rl_3_5_kunjungan_pdf', [
            'tanggalAwal' => $tanggalAwal,
            'tanggalAkhir' => $tanggalAkhir,
        ...
        $filename = 'RL_3_5_Kunjungan_' . date('d-m-Y', strtotime($tanggalAwal)) . '_sd_' . date('d-m-Y', strtotime($tanggalAkhir)) . '.pdf';
    ...
    public function rl34Pengunjung(Request $request)
    {
        ...
        return view('rm.laporan_rm.rl_3_4_pengunjung', [
            'tanggalAwal' => $tanggalAwal,
            'tanggalAkhir' => $tanggalAkhir,
    ...
    {
        $pdf = PDF::loadView('rm.laporan_rm.rl_3_4_pengunjung_pdf', [
            'tanggalAwal' => $tanggalAwal,
            'tanggalAkhir' => $tanggalAkhir,
            'pengunjungBaru' => $pengunjungBaru,
            'pengunjungLama' => $pengunjungLama,
        ...
        $filename = 'RL_3_4_Pengunjung_' . date('d-m-Y', strtotime($tanggalAwal)) . '_sd_' . date('d-m-Y', strtotime($tanggalAkhir)) . '.pdf';
